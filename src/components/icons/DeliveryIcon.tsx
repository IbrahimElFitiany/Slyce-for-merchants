...
export function DeliveryIcon({ size = 20, color = "currentColor", className }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <path
        ...
        strokeWidth={3}
      />
      <ellipse cx="18.31" cy="43.31" rx="3.71" ry="3.76" stroke={color} strokeWidth={3} />
      <ellipse cx="45.35" cy="43.31" rx="3.71" ry="3.76" stroke={color} strokeWidth={3} />
      <line
        x1="23.25"
        y1="22.36"
        x2="6.87"
