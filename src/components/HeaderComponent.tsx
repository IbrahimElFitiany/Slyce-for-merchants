function HeaderComponent() {
  return (
    <div
      id="nav"
      className="z-10 flex h-auto w-full items-center justify-between bg-[#FFFAF0] px-68 py-2.5 font-[InterVariable] text-[16px] text-[#4CB050]"
    >
      <div id="logo" className="flex items-center text-[19px] font-medium tracking-tight">
        <img src="/images/greenLogo.png" alt="" className="size-15" />
        <p className="">for Merchant</p>
      </div>

      <ul className="hidden space-x-11 text-lg font-semibold md:flex">
        <li>
          <a
            href="#"
      ...
      <div className="flex h-[48px] items-center space-x-3 font-bold">
        <button className="flex h-full items-center gap-3 rounded-full border border-[#4CB050] px-2 py-1.5">
          <svg
            width="32"
            height="32"
            viewBox="0 0 24 24"
            ...
            aria-hidden="true"
            className="sc-fqkvVR gftmuU fetched-icon"
          >
            <path
              fill-rule="evenodd"
              clip-rule="evenodd"
        ...
        <button className="h-full rounded-full bg-[#4CB050] px-7 py-3 text-white">
          Login
        </button>
      </div>
    </div>
